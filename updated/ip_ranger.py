...
while True:
    ...
    print('')
    print(' [KEY]')
    print('       [DEVELOPER TOOL] Creates files of address ranges with the ability to verify files created if')
    print('                        needed.')
    print('                        Modules/Files SHOULD be verified before compile time, especially the greater')
    print('                        time between module creation time and compile time.')
    print('                        Verify THEN compile program "x" that imports address range modules.')
    print('')
